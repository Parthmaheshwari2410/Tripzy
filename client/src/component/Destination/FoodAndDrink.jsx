...
const FoodAndDrink = ({ room, index }) => {
    return (
        <Link to={'/restarents/' + room._id} onClick={() => scrollTo(0, 0)} key={room._id}
            ...
            <img src={room.restarentsImages} alt="" />
            ...
            <div className='p-4 pt-5'>
                <div className='flex items-center justify-between'>
                    <p className='font-playfair text-xl font-medium text-gray-800'>{room.restarentsName}</p>
                ...
                <div className='flex items-center justify-between mt-4'>
                    <p><span className='text-xl text-gray-800'>{room.restarentsPrices}</span></p>
                </div>
            </div>
        </Link>
    )
