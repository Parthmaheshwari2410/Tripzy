    ...
    return (
        ...
        >
            <div className="relative w-full h-48 sm:h-56 overflow-hidden">
                <img
                    src={room.imagess || assets.placeholder}
                    alt={room.titles || 'Place image'}
            ...
            <div className="p-4">
                <div className="flex items-start justify-between gap-2">
                    <p className="font-playfair text-lg sm:text-xl font-medium text-gray-800 line-clamp-2">
                        {room.titles}
                    </p>
